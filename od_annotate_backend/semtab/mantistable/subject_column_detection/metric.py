...
from semtab.mantistable.subject_column_detection.utils import generate_datatype_frequency_table
from semtab.mantistable.utils.data_type import DataTypeEnum
from semtab.mantistable.utils.nlp import utils


class Metric(ABC):
    @abstractmethod
    def computeRve(self, tabledataRve):
...
class UCMetric(Metric):
    ...
    def computeRve(self, tableDataRve):
        ...
        col = tableDataRve.data[self.col_idx]
        unique_cells = set()
